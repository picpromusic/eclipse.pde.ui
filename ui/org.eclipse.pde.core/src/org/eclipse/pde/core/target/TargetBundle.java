...
public class TargetBundle {
	 ...
	 */
	public TargetBundle(BundleInfo info, ITargetLocation parentContainer, IStatus status, BundleInfo sourceTarget, boolean optional, boolean fragment) {
		fInfo = info;
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#getBundleInfo()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#getParentContainer()
	 */
	public ITargetLocation getParentContainer() {
		return fContainer;
	}

	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#setParentContainer(org.eclipse.pde.core.target.ITargetLocation)
	 */
	public void setParentContainer(ITargetLocation newParent) {
		fContainer = newParent;
	}

	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#getStatus()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#isOptional()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#isSourceBundle()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#getSourceTarget()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.pde.core.target.IResolvedBundle#isFragment()
	 */
